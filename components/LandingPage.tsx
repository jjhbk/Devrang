...
const testimonials = [
  {
    quote:
      "devrang helped me find a last-minute anniversary gift that was so personal and thoughtful. My wife was speechless! I'll never scroll endlessly again.",
    author: "Rohan S.",
  },
  {
    quote:
      "As someone who's very particular about fragrances, I was skeptical. But the AI understood the 'vibe' I wanted perfectly. I've found my new signature scent.",
    author: "Anjali M.",
  },
];
    ...
    <div className="bg-[#FDFBF7] text-amber-900 font-sans">
      ...
      <header className="relative flex flex-col items-center justify-center h-screen min-h-[600px] p-8 text-center text-white">
        ...
        <div className="relative z-10">
          <h1 className="text-6xl md:text-8xl font-serif tracking-wider mb-4">
            devrang
          </h1>
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-12">
            Discover meaningful gifts and signature perfumes through a
            conversation, not a search bar.
          </p>
          <button
            onClick={onLogin}
        ...
        <section className="py-20 px-8 bg-white">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-stone-600 mb-12 max-w-2xl mx-auto">
              Skip the endless scrolling. Describe your vision, and let our AI
              curator find items with soul.
            </p>
            <div className="grid md:grid-cols-3 gap-12 text-left">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-stone-500">
                  Tell us about the person, the occasion, or the feeling you
                  want to capture.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  2. Receive Curated Ideas
                </h3>
                <p className="text-stone-500">
                  devrang presents a few thoughtful recommendations, complete
                  with their stories.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  3. Discover the Perfect Match
                </h3>
                <p className="text-stone-500">
                  Compare options and find a gift that truly resonates and
                  delights.
                </p>
              </div>
            </div>
      ...
      <footer className="bg-stone-800 text-stone-300 py-12 px-8">
        <div className="max-w-5xl mx-auto text-center">
          <h3 className="text-3xl font-serif text-white mb-4">devrang</h3>
